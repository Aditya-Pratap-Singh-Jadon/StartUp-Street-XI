...
export default function Content() {
     ...
     *
     * The actual page still uses normal browser scrolling.
     * We only ease the movement so wheel scrolling doesn't
     * stop abruptly.
     */
    ...
    useEffect(() => {
        ...
        const handleWheel = (event) => {
            /*
             * Don't interfere with tiny trackpad movements.
             */
            ...
            /*
             * Accumulate the wheel movement instead of
             * directly moving the page.
             */
        ...
        const animateScroll = () => {
            ...
            /*
             * Lower value = smoother / slower finish.
             *
             * The movement naturally slows down as it
             * approaches the target.
             */
            const next =
                current + distance * 0.075;
        ...
        const syncTarget = () => {
            /*
             * Keep target synchronized when the user
             * resizes the browser or uses scrollbar.
             */
            if (!isAnimating.current) {
    ...
    const scrollToSection = (id) => {
        ...
        const animate = () => {
            ...
            /*
             * Same easing as wheel scrolling.
             */
            window.scrollTo(
                0,
                current + distance * 0.065
            );
    ...
    /*
     * Prevent default anchor jump and use our
